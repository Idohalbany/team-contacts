export function About() {
  return (
    <section className='about'>
      <h1>About Us</h1>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas architecto dolore quia fugit?
        Laborum et obcaecati quas quasi quam error. Distinctio magnam blanditiis laudantium vel
        expedita illum? Perferendis praesentium nam, beatae ad rerum, doloribus provident, impedit
        dicta aliquam nihil veritatis.
      </p>
      <p>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est maiores optio labore minus,
        quidem repudiandae officia corrupti id fuga ratione.
      </p>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, aliquid necessitatibus eius
        dolores explicabo tempora quidem quo ratione eligendi dolore qui pariatur, vitae consequatur
        porro doloremque molestias nemo cum reiciendis optio! Voluptas nesciunt est eius nemo facere
        harum consequuntur, dolorum possimus assumenda!
      </p>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Error consectetur, ullam cumque
        suscipit illo a?
      </p>
      <h3>Our Team</h3>
      <p>
